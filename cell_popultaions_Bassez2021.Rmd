...
A1 <- DimPlot(data.c1, reduction = "umap", group.by = "cellType")  + ggtitle("") +
  theme(legend.text = element_text(size=8), aspect.ratio = 1) + labs(subtitle = "Cohrt 1") + NoLegend()

A2 <- DimPlot(data.c2, reduction = "umap", group.by = "cellType")  + ggtitle("") +
  theme(legend.text = element_text(size=8), aspect.ratio = 1) + labs(subtitle = "Cohrt 2")
